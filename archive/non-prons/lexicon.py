#!/usr/bin/env python3
# lexicon.py jcj 2019-02-20, 2020-01-23, 2020-02-07
...
class Lexicon:
	...
	PHASES = 4   # How many times is each entry processed?
	...
	def __init__(self, fileName, caseBlind=False, diacBlind=False, busyWait=None):
		...
		busyWait(self.HASHING, round(pcDone))
		for line in lines: 
			pcDone += pcPerLine
			if pcDone % self.INTERVAL < pcPerLine:
				busyWait(self.HASHING, round(pcDone))
